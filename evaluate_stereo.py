...
def validate_argoverse(model, iters=32, mixed_prec=False):
    """ Peform validation using the Argoverse (val) split """
    model.eval()
    aug_params = {}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', help="dataset for evaluation", required=True, choices=["eth3d", "kitti", "things", "osu", "argoverse"] + [f"middlebury_{s}" for s in 'FHQ'])
